    ...
    <section className="border-b border-cream-300/60 bg-cream-50 py-6 sm:py-8">
      <Container>
        ...
        <div className="relative">
          ...
          <div
            className="-mx-4 flex snap-x items-start gap-x-8 overflow-x-auto px-4 pb-2 sm:gap-x-12 md:justify-center md:gap-x-16 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
            data-cat-scroll
          >
